  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message: 'Marcus Vance from Roads & Infrastructure has been dispatched to repair your reported road defect.',
      time: '1 hour ago',
      read: false,
      icon: '👷',
    },
    ...
    },
    {
      ...
      message: 'Electrical crew is currently on-site at Pine Avenue repairing the exposed street pole wiring.',
      time: 'Yesterday',
      read: true,
      icon: '⚡',
    },
    {
      ...
      message: 'Field worker Marcus Vance uploaded mandatory photographic proof of completed asphalt restoration.',
      time: 'Yesterday',
      read: true,
      icon: '✅',
    },
